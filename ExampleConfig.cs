...
#pragma warning restore CS0169
	...
	public class ModConfigShowcaseDataTypes : ModConfig
	{
		...
		// EntityDefinition classes store the identity of an Entity (Item, NPC, Projectile, etc) added by a mod or vanilla. Only the iden`tity is preserved, not other mod data or stack.
		...
		public Dictionary<PrefixDefinition, float> SomeClassE = new Dictionary<PrefixDefinition, float>() {
			[new PrefixDefinition("CorruptMod", "Awesome")] = 0.5f,
			[new PrefixDefinition("CorruptMod", "ReallyAwesome")] = 0.8f
		};
	...
	public class ModConfigShowcaseLabels : ModConfig
	{
		...
		[Label("$Mods.CorruptMod.Common.LocalizedLabel")]
		[Tooltip("$Mods.CorruptMod.Common.LocalizedTooltip")]
		public int LocalizedLabel;

		[Label("$Mods.CorruptMod.Common.LocalizedLabelDynamic")]
		...
		[Header("$Mods.CorruptMod.Common.LocalizedHeader")]
